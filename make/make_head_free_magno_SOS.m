...
%       -
%
rootdir = 'E:\EXPERIMENTS\MAGNO\Experiment_SOS_norm_81';
...
IOFreq = [0.3 0.5 0.7 1.1 1.65 2.55 3.85 5.9 8.95]';
% [8.95;5.9;3.85;2.55;1.65;1.1;0.7;0.5;0.3];
...
for n = 1:N.file
    ...
    % Store signals
    n_detrend = 1;
    DATA.reference{n}  = singal_attributes(pat_pos, pat_time);
...
for n = 1:1
    ...
    plot(DATA.reference{n}.time, ...
        DATA.reference{n}.position - sync + x_start, 'r', 'LineWidth', 1);
    %test(:,n) = DATA.reference{n}.position;
    test(:,n) = DATA.reference{n}.mag.velocity;
end
