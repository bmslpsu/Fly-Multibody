function [] = make_head_free_magno_SOS_head_body(rootdir)
%% make_head_free_magno_SOS_head_body:
%
%   INPUTS:
...
rootdir = 'E:\EXPERIMENTS\MAGNO\Experiment_SOS_vel_v2_haltere_cut';
...
%     cla
	...
	SYS_all = CatStructFields(2, SYS_ref2_head_body, SYS_body2_head, SYS_err2_head_body);
