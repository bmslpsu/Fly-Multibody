function [MOV] = montage_SOS_body_fixed(rootdir,rootpat,vidFs,export)
%% montage_SOS_body_fixed: makes movie for fly in magnetic tether
%
...
FLY.wing_length = 150;
FLY.lwing_hinge = [FLY.raw_xP , 0] + [-params.gui.right.hinge.x  , params.gui.right.hinge.y];
FLY.rwing_hinge = [FLY.raw_xP , 0] + [-params.gui.left.hinge.x , params.gui.left.hinge.y];
