function [MOV] = montage_SOS_head_fixed_no_wing(rootdir,rootpat,vidFs,export)
%% montage_SOS_head_fixed_no_wing: makes movie for fly in magnetic tether
%
...
if dirflag
    ...
    [FILE.raw, PATH.body_track] = uigetfile({'*.mat'}, ...
        'Select fly file', PATH.body_track, 'MultiSelect','off');
...
FLY.body_glob = -1;
FLY.head_length = 38;
FLY.head_hinge = fliplr(fix(padsize)) + [params.gui.axis.pt2.x, params.gui.axis.pt2.y + 4] ;
