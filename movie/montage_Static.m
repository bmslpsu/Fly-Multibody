function [MOV] = montage_Static(rootdir,rootpat,vidFs,export)
%% montage_Static: makes movie for fly in magnetic tether
%
...
set(ax(6), 'YLim', (head_ylim)*[-1 1], 'YTick', head_ylim*[-1 0 1])
set(ax(3), 'YLim', 10*[-1 1])
