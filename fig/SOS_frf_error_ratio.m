...
for v = 1:n_cond
    ...
    ErrorRatio.fly(v).bodyfree2headfree = HeadFree.FRF_data.ref2head.fly(v).error ./ ...
                                    HeadFree.FRF_data.ref2body.fly(v).error;
    ...
    ErrorRatio.fly(v).bodyfree2gazefree = HeadFree.FRF_data.ref2gaze.fly(v).error ./ ...
                                    HeadFree.FRF_data.ref2body.fly(v).error;
    ...
    ErrorRatio.mean(v).bodyfixed2bodyfree = HeadFixed.FRF_data.ref2body.grand_mean(v).error ./ ...
                                        HeadFree.FRF_data.ref2body.grand_mean(v).error;
    % How head-fixation effects gaze
    ErrorRatio.mean(v).bodyfixed2gazefree = HeadFixed.FRF_data.ref2body.grand_mean(v).error ./ ...
                                        HeadFree.FRF_data.ref2gaze.grand_mean(v).error;
    % How body-fixation effects head
    ErrorRatio.mean(v).headfree2gazefixed = BodyFixed.FRF_data.ref2head.grand_mean(v).error ./ ...
                                        HeadFree.FRF_data.ref2head.grand_mean(v).error;
    % How body-fixation effects gaze
    ErrorRatio.mean(v).gazefree2gazefixed = BodyFixed.FRF_data.ref2head.grand_mean(v).error ./ ...
                                        HeadFree.FRF_data.ref2gaze.grand_mean(v).error;
...
for n = 1:n_field
    for v = 1:n_cond
        ...
        ax(n,v) = subplot(n_field,n_cond,pp); hold on
            ...
            plot(IOFv, ErrorRatio.fly(v).(T(n)), 'Color', [0.5 0.5 0.5 0.5], 'LineWidth', 0.5)
            [h.patch(n,v),h.line(n,v)] = PlotPatch(ErrorRatio.mean(v).(T(n)),...
                      ErrorRatio.std(v).(T(n)), IOFv, 0, 1, cc(n,:), 0.7*cc(n,:), 0.2, 1);
...
leg.Position = [0.66 0.28 0.23 0.18];
set(h.line, 'Marker', '.','MarkerFaceColor', 'none', 'MarkerSize', 10, 'LineWidth', 1)
set(ax, 'Color', 'none', 'LineWidth', 1, 'FontSize', 8, 'XLim', [0.2 20],...
    'XGrid', 'off', 'YGrid', 'off', 'Box', 'off')
set(ax, 'XTick', [0.1, 1 10])
