...
for v = 1:N.freq
    for f = 1:N.fly
        FRF_data.fly(v).wing2body(f) = frf(time, ALL.fly(v).wing(:,f), IOFv(v), false, ...
                                                ALL.fly(v).body(:,f));
        if FRF_data.fly(v).wing2body(f).IOCohr > 0.3
...
ax(1,1) = subplot(4,1,1); hold on
    %plot(IOFv, FRF_data.wing2body_mag, '-b.', 'LineWidth', 1, 'MarkerSize', 10)
...
ax(2,1) = subplot(4,1,2); hold on
    %plot(IOFv, FRF_data.wing2body_gain, '-b.', 'LineWidth', 1, 'MarkerSize', 10)
...
ax(3,1) = subplot(4,1,3); hold on
    %plot(IOFv, FRF_data.wing2body_phase, '-b.', 'LineWidth', 1, 'MarkerSize', 10)
...
ax(4,1) = subplot(4,1,4); hold on
    %plot(IOFv, FRF_data.wing2body_cohr, '-b.', 'LineWidth', 1, 'MarkerSize', 10)
...
set(ax, 'Color', 'none', 'LineWidth', 0.75, 'FontSize', 10, 'XLim', [0.6 12],...
