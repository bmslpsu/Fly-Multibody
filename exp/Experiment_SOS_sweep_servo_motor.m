function [] = Experiment_SOS_sweep_servo_motor(Fn)
%% Experiment_SOS_sweep_servo_motor: runs a experiment using the LED arena and fly panel
...
switch yPos
    case 12
        root = 'C:\BC\Experiment_SOS_vel_v2_servomotor_bright';
    case 1
        root = 'C:\BC\Experiment_SOS_vel_v2_servomotor_dark';
    case 5
        root = 'C:\BC\Experiment_SOS_vel_v2_servomotor_grating';
    otherwise
...
% DAQ Setup
[s,~] = MC_USB_1208FS_PLUS_motor_all_servo(Fs);
...
motor_time = (0:0.001:20)';
motor_pos = 3*sin(2*pi*10*motor_time);
...
[motor_signal, daq_time, max_range] = servo_signal_daq(s.Rate, motor_new, motor_time_new, true);
...
for ii = 1:n_trial
    ...
    save(fullfile(root,fname), '-v7.3', 'data', 't_p', 'vidData', 't_v',...
        'AO', 'yPos', 'motor_new', 'motor_time_new');
end
