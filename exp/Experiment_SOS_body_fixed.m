function [] = Experiment_SOS_body_fixed(Fn)
%% Experiment_SOS_body_fixed: runs a experiment using the LED arena and fly panel
% Fn is the fly number
daqreset
imaqreset
% Fn = 0;
%% Set directories & experimental parameters
root = 'C:\BC\Experiment_SOS_body_fixed';
...
func = [1]';  % position function indicies
vel = [1]'; % normalize veloctiy of each SOS function
