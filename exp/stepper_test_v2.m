...
servo_signal = 20*sin(2*pi*1*servo_time);
...
% 
% display_data = replay_body;
% display_time = replay_time;
% 
...
% AO = [TRIG, pulse_dir_signal];
%%
% AO = [pulse_dir_signal, TRIG];
